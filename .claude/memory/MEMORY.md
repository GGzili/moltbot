...
- To sync upstream fixes:
  ...
  3. Filter out deleted channel fixes, cherry-pick relevant ones
  4. `git push origin main`
- Deleted channels to filter out: telegram, discord, slack, whatsapp, signal, imessage, irc, line, matrix, msteams, googlechat, feishu, bluebubbles, mattermost, nextcloud-talk, nostr, synology-chat, tlon, twitch, zalo, zalouser
